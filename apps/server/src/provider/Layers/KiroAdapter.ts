/**
 * KiroAdapterLive — Kiro CLI (`agent acp`) via ACP.
 *
...
function applyRequestedSessionConfiguration<E>(input: {
  ...
  readonly modelSelection:
    | {
        ...
        readonly options?: KiroModelOptions | null | undefined;
      }
    | undefined;
...
function makeKiroAdapter(options?: KiroAdapterLiveOptions) {
  return Effect.gen(function* () {
    ...
    const emitPlanUpdate = (
      ...
      rawPayload: unknown,
      source: "acp.jsonrpc" | "acp.kiro.extension",
      method: string,
    ) =>
      Effect.gen(function* () {
    ...
    const startSession: KiroAdapterShape["startSession"] = (input) =>
      withThreadLock(
        ...
        Effect.gen(function* () {
          ...
          const kiroSettings = yield* serverSettingsService.getSettings.pipe(
